                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nm_cliente" id="nm_cliente"
                                                placeholder="Nome" value="<?php echo htmlspecialchars( $user["nm_cliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="nr_celular">Celular</label>
                                            <input type="tel" class="form-control" name="nr_celular" id="nr_celular"
                                                placeholder="(00) 0.0000-0000" value="<?php echo htmlspecialchars( $user["nr_celular"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" maxlength="16" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nr_cep" id="nr_cep" placeholder="00000-000"
                                                maxlength="9" value="<?php echo htmlspecialchars( $user["nr_cep"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nm_logradouro" id="nm_logradouro"
                                                placeholder="Rua" value="<?php echo htmlspecialchars( $user["nm_logradouro"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
