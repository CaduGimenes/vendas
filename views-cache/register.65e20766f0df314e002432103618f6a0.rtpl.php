                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="nm_bairro" id="nm_bairro" class="form-control" required>
                                        <option disabled>Selecione um bairro</option>
                                        <?php $counter1=-1;  if( isset($districtValues) && ( is_array($districtValues) || $districtValues instanceof Traversable ) && sizeof($districtValues) ) foreach( $districtValues as $key1 => $value1 ){ $counter1++; ?>

                                        <option value="<?php echo htmlspecialchars( $value1["cd_bairro"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["nm_bairro"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                                        <?php } ?>
